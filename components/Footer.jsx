    ...
    <footer className="footer">
      ...
      <div className="footer-content container">
        ...
        <div className="footer-brand">
          <h3 className="footer-name">Oasi Dolce Vita</h3>
          ...
          <div className="footer-social">
            ...
            <a
              href="https://www.instagram.com/oasidolcevita"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-social-link"
            ...
            <a
              href="https://www.youtube.com/@oasidolcevita"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-social-link"
              aria-label="YouTube"
      ...
      <div className="footer-bottom">
        <div className="container">
          <p>© 2026 Oasi Dolce Vita — {t('footer.rights')}</p>
          <p>
            {t('footer.designedBy')}{' '}
            <a
              href="https://www.effettoweb.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              Effettoweb
